...
<body>
   ...
   <?php }?>
        ...
        <section class="product-details">
            <div class="image-slider">
                <div class="product-images">
                    <img src="../images/tshirt2.webp" class="active" alt="">
                    <img src="../images/tshirt2b.webp" alt="">
                    <img src="../images/tshirt2c.webp" alt="">
                </div>
            </div>
            <div class="details">
                <h2 class="product-brand">Social Introvert Oversized T-Shirt</h2>
        ...
        <section class="detail-des">
            ...
            <p class="des">
                Introducing our stylish white t-shirt with vibrant green letters that proudly proclaim "I'm new". This trendy and comfortable shirt is perfect for those who want to make a bold statement and showcase their fresh perspective.  <br>What's on print:
<br>
                Front: INTROVERT
                <br>Back: SOCIAL INTROVERT <br>
                <b>Material:</b>Cotton Lycra
                <br>
               <b>FIT:</b>Oversized Feel
               <br>
               <b>DESIGN:</b> Originally inspired by Social anxiety
               <br></p>
        </section>
