    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $(".generate_qr").click(function () {
                ...
                $(".qr_code").show();
                var num = $(".number").val();
                var link = "upi://pay?pa=kunalstark2003@oksbi%26pn=Kunal%20Yadav%26tn="+num;
...
<body>
    <section>
        ...
        <div class="qr_code m20">
            <p>Scan the QR Code with any UPI App and pay the amount then Proceed</p>
            <center><img src="" alt="QR CODE" class="get_qr m10"></center>
            <center><img src="images/upi.jpeg" class="im m10"></center>
            <div class="flex m20">
            ...
            <br>
            <button role="button">
                <a href="http://wa.me/+919779228341" class="btn1">
                    Proceed
                </a>
            </button>
        </div>
